...
public class FornecedorController {
	...
	@GetMapping("/cep/{cep}")
	public ResponseEntity<CadastroCepDTO> consultarCep(String cep) {
		CadastroCepDTO cadCepEmpresaDTO = fornecedorService.consultarCep(cep);
		if(null == cadCepEmpresaDTO)
			throw new NoSuchElementFoundException("Não foi encontrado o CEP informado");
		else
			return new ResponseEntity<>(cadCepEmpresaDTO, HttpStatus.OK);
	}
