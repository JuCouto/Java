...
public class Fornecedor {
	...
	public FornecedorDTO converterEntidadeParaDto() {
		
		return new FornecedorDTO(idFornecedor, cnpj, 
				tipo, razaoSocial, uf, telefone, email, nomeFantasia, 
				statusSituacao, bairro, logradouro, numero, complemento, cep, municipio, dataAbertura);
